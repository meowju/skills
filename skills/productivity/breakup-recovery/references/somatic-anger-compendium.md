### The Body Stores Anger — Somatic Approaches to Completing the Response

Anger is not only a mental event. It is a full-body physiological response — and it resolves through the body, not only through thinking. Cognitive approaches alone (journaling, reframing) often feel like they help but do not fully discharge the anger. The stress hormones mobilized by anger (cortisol, adrenaline) need a physical exit route.

**Where anger lives in the body:** chest tightness needing to expand outward; jaw clenching; hands and fists (impulse to hit or push); gut-level churning; throat tension (holding back words you cannot speak). These are not metaphor — they are the somatic signature of incomplete anger.

Anger needs to complete its arc: mobilization (body prepares for action), expression (scream, write, move), and resolution (nervous system registers the threat as addressed). Exercise handles step 1. Steps 2 and 3 need somatic work.

**Five evidence-based somatic approaches:**
...
2. **Complete breath** — Full inhale (belly, then chest), hold 3 seconds, long exhale (6–8 seconds). The long exhale activates the vagus nerve and tells the nervous system the threat has ended. Do 10–15 cycles. If tears come, let them — grief often lives underneath the anger.

3. **Bilateral tapping** — Alternate tapping left-right-left-right on your thighs or shoulders while staying with the anger. Bilateral movement (used in EMDR therapy) helps the brain complete the processing cycle that gets stuck in rumination. Especially effective for anger that keeps replaying the same memory.

4. **Vocalization** — Anger requires sound. Scream into a pillow, hum a low sustained note, or make a loud "ha" on a long exhale. Suppressed anger stays in the body. The sound mechanism in anger is real — silencing it siloes the anger in the nervous system. Best done privately.
